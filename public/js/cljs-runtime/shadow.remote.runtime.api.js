...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17616 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17616(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17617 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17617(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_17618 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_17618(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17619 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17619(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17621 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17621(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17609,callback){
var map__17610 = p__17609;
var map__17610__$1 = cljs.core.__destructure_map(map__17610);
var input = map__17610__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17610__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17610__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
